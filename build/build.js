...
const mergeWord = (entryValue, entry, lexicon) => {
...
for (var lexicon in rawLexicon) {
  console.log(`Merging ${lexicon} into Normalized Lexicon...`)
  for (var entry in rawLexicon[lexicon]) {
    switch (lexicon) {
      case 'AFINN':
        mergeWord(
          rawLexicon[lexicon][entry].word,
      ...
      case 'AFINN-E':
        mergeWord(
          rawLexicon[lexicon][entry].emoji,
          rawLexicon[lexicon][entry],
          lexicon
        )
        break
      ...
      case 'MPQA':
        mergeWord(
          rawLexicon[lexicon][entry].word1,
          rawLexicon[lexicon][entry],
          lexicon
        )
        break
